...
SOLR_SERVICE_BOOST_TYPES = {'astronomy': 'astronomy_final_boost', 'physics': 'physics_final_boost', 'earth_science': 'earth_science_final_boost', 'planetary_science': 'planetary_science_final_boost', 'heliophysics': 'heliophysics_final_boost', 'general': 'general_final_boost'}
