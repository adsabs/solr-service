...
SOLR_SERVICE_ALLOWED_STATS_FIELDS = ['citation_count', 'read_count', 'citation_count_norm', 'credit_count']
SOLR_SERVICE_ALLOWED_HIGHLIGHTS_FIELDS = ['title', 'abstract', 'keyword', 'author']
...
ANONYMOUS_SOLR_SERVICE_URL = os.environ.get('ANONYMOUS_SOLR_SERVICE_URL', BOT_SOLR_SERVICE_URL)
ANONYMOUS_SOLR_SERVICE_SEARCH_HANDLER = ANONYMOUS_SOLR_SERVICE_URL + '/select'
ANONYMOUS_SOLR_SERVICE_BIGQUERY_HANDLER = ANONYMOUS_SOLR_SERVICE_URL + '/bigquery'
BOT_TOKENS = []
